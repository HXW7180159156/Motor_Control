...
/**
 * @brief Initialize the motor control instance with given configuration
 * @param inst Pointer to motor control instance
 * @param cfg Pointer to system configuration
 * @return Status code indicating success or failure
 */
mc_status_t mc_init(mc_instance_t *inst, const mc_system_cfg_t *cfg);

/**
 * @brief Reset the motor control instance to default state
 * @param inst Pointer to motor control instance
 * @return Status code indicating success or failure
 */
...
/**
 * @brief Start the motor control operation
 * @param inst Pointer to motor control instance
 * @return Status code indicating success or failure
 */
...
/**
 * @brief Start motor parameter identification (autotuning)
 * @param inst Pointer to motor control instance
...
/**
 * @brief Check if motor parameter identification is complete
 * @param inst Pointer to motor control instance
 * @return MC_TRUE if identification is complete, MC_FALSE otherwise
 */
mc_bool_t mc_is_identification_done(const mc_instance_t *inst);

/**
 * @brief Get identified motor parameters
 * @param inst Pointer to motor control instance
 * @param params Output motor parameters structure
...
/**
 * @brief Stop the motor control operation
 * @param inst Pointer to motor control instance
 * @return Status code indicating success or failure
 */
...
/**
 * @brief Set the torque reference
 * @param inst Pointer to motor control instance
 * @param torque_ref Torque reference
 * @return Status code indicating success or failure
 */
mc_status_t mc_set_torque_ref(mc_instance_t *inst, mc_f32_t torque_ref);

/**
 * @brief Set the dq-axis current references directly
 * @param inst Pointer to motor control instance
...
/**
 * @brief Execute the fast control step (high-frequency, e.g. current loop)
 * @param inst Pointer to motor control instance
 * @param in Fast input data (ADC samples, fault signals)
 * @param out Fast output data (PWM commands)
 * @return Status code indicating success or failure
 */
mc_status_t mc_fast_step(mc_instance_t *inst, const mc_fast_input_t *in, mc_fast_output_t *out);

/**
 * @brief Execute the medium-speed control step (e.g. speed loop)
 * @param inst Pointer to motor control instance
 * @param in Medium input data (speed feedback, encoder count)
 * @param out Medium output data (angle, speed, current references)
 * @return Status code indicating success or failure
 */
mc_status_t mc_medium_step(mc_instance_t *inst, const mc_medium_input_t *in, mc_medium_output_t *out);

/**
 * @brief Execute the slow control step (low-frequency monitoring)
 * @param inst Pointer to motor control instance
 * @param in Slow input data (temperature, fault clear request)
 * @param out Slow output data (mode, diagnostics)
 * @return Status code indicating success or failure
 */
mc_status_t mc_slow_step(mc_instance_t *inst, const mc_slow_input_t *in, mc_slow_output_t *out);

/**
 * @brief Get the current status of the motor control instance
 * @param inst Pointer to motor control instance
...
/**
 * @brief Get the diagnostic information
 * @param inst Pointer to motor control instance
