...
int main(void)
{
    ...
    RUN_TEST(test_mc_debug_transp_valid_frame_detected);
    RUN_TEST(test_mc_debug_transp_bad_magic_rejected);
    RUN_TEST(test_mc_debug_transp_good_magic_bad_len_resets);
    RUN_TEST(test_mc_debug_transp_send_calls_flush);
    RUN_TEST(test_mc_debug_fm_get_info_responds);
